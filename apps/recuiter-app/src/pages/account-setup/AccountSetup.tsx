import Building from "@/assets/svg/account-setup/building.svg";
...
import { ACCOUNT_SETUP, PROFILE } from "@/routes";
import {
    AccountSetupField,
    accountSetupSchema,
...
const AccountSetup: React.FC = () => {
    ...
    return (
        <div className="flex h-screen font-manrope bg-[#F7FAFF]">
            <div className="lg:block hidden w-[250px] bg-primary text-white">
                <div className="flex flex-col items-center gap-10 p-6">
                    ...
                    <div className="w-full">
                        <Link
                            to="/account-setup"
                            className="text-white bg-white/17 text-lg py-2 pl-3 rounded-lg w-full flex gap-2"
                        >
                            <img
                                src={Building}
                                alt="Building-icon"
            ...
            <div className="overflow-auto lg:w-[calc(100%-250px)] w-full py-4 pl-4 lg:pr-20 pr-4">
                                ...
                                {logoImgWatcher ? (
                                    <>
                                        <img
                                            ...
                                            alt="No Image"
                                            className="w-full h-full object-contain rounded-full bg-[#F7FAFF]"
                                        />
                        ...
                        <div className="flex flex-col gap-8 lg:w-3/4">
                            ...
                            <div className="flex md:flex-row flex-col gap-4">
                                <AuthInput
                                    ...
                                    errorMsg={
                                        accountSetupForm.formState.errors.email
                                    }
                                />
                                ...
                                <AuthPhone
                                    ...
                                    errorMsg={
                                        accountSetupForm.formState.errors.phone
                                    }
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-center ">
                                <AuthButton
                                    ...
                                    type="button"
                                    disabled={isLoading}
                                    onClick={accountSetupForm.handleSubmit(
                                        onSubmit
                                    )}
                                >
                                    {isLoading ? (
