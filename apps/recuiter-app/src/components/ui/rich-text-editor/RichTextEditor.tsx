...
const RichTextEditor = () => {
  ...
  return (
    <div className="w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto sm:px-6 lg:px-2 bg-[#fffdfd] rounded-2xl border-[2px] border-[#ffffff] overflow-hidden">
      {/* Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-6 border-b border-gray-100 bg-gray-50/50 gap-4 sm:gap-0">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 rounded-full flex items-center justify-center">
            <span className="text-purple-700 font-bold text-lg sm:text-xl">L</span>
          </div>
          <div>
            <div className="text-sm sm:text-base font-bold text-gray-900">Leslie A.</div>
            <div className="text-xs sm:text-sm text-gray-500">Frontend Designer</div>
          </div>
        </div>
        <div className="relative w-full sm:w-auto">
          <button
            onClick={handleCopy}
            className="flex items-center justify-center space-x-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors duration-150 w-full sm:w-auto"
          >
            <svg
              className="w-4 h-4 text-[#3D1562]"
              viewBox="0 0 24 24"
      ...
      {/* Custom Toolbar */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-t mx-2 sm:mx-4 lg:mx-8 rounded-t-xl border-gray-100 bg-[#7517cc1f] gap-3 sm:gap-0">
        <div className="flex items-center flex-wrap gap-2 sm:gap-4 w-full sm:w-auto">
          ...
          <div className="flex items-center space-x-1">
            <button
              className={`px-2 py-1 hover:bg-gray-100 rounded transition-colors duration-150 font-bold text-base sm:text-lg ${
                isFormatActive("bold")
                  ? "bg-gray-200 text-gray-900"
                  : "text-gray-700"
              }`}
            ...
            <button
              className={`px-2 py-1 hover:bg-gray-100 rounded transition-colors duration-150 italic text-base sm:text-lg ${
                isFormatActive("italic") ? "bg-gray-200" : "text-gray-700"
              }`}
              title="Italic"
              onMouseDown={(e) => e.preventDefault()}
            ...
            <button
              className={`px-2 py-1 hover:bg-gray-100 rounded transition-colors duration-150 underline text-base sm:text-lg ${
                isFormatActive("underline") ? "bg-gray-200" : "text-gray-700"
              }`}
              title="Underline"
              onMouseDown={(e) => e.preventDefault()}
      ...
      {/* Editor */}
      <div className="relative bg-[#7517cc1f] mx-2 sm:mx-4 lg:mx-8">
        <div
          ref={editorRef}
          contentEditable
          className="min-h-40 sm:min-h-48 md:min-h-50 px-3 sm:px-4 md:px-6 py-3 sm:py-4 text-sm leading-relaxed text-gray-700 focus:outline-none editor-content overflow-y-auto"
          onKeyDown={handleKeyDown}
          onInput={handleInput}
          suppressContentEditableWarning={true}
        />
      ...
      {/* Footer */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end space-y-2 sm:space-y-0 sm:space-x-3 px-4 sm:px-6 py-4 rounded-b-xl border-t border-gray-100 mx-2 sm:mx-4 lg:mx-8 mb-4 sm:mb-6 lg:mb-8 bg-[#7517cc1f]">
        <button className="px-4 sm:px-6 py-2 text-sm text-[royalPurple] bg-[#fafafa] border-[2px] border-[#3d15623b] hover:bg-purple-100 transition-colors duration-150 rounded-lg hover:border-gray-300 order-2 sm:order-1">
          Cancel
        </button>
        <button className="px-4 sm:px-6 py-2 bg-[#fafafa] border-[2px] border-[#3d15623b] text-sm rounded-lg hover:bg-purple-100 transition-colors duration-150 font-medium order-1 sm:order-2">
          <span className="bg-gradient-to-r from-[#3F1562] to-[#DF6789] bg-clip-text text-transparent">
            Done
          </span>
        </button>
