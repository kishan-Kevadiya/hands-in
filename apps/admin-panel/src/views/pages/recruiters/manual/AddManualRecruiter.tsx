...
import { PhoneTypes, QUERY_KEYS } from "@utils/constants";
...
const AddManualRecruiter = () => {
    ...
    const addRecruiterMutation = useMutation<any, unknown, AddRecruiterForm, unknown>(
        () => ({
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <div class="phones-group">
                        <section class="d-flex gap-2 align-center mb-2">
                            ...
                            <FormFields.CircleButton variant="success" href="" onClick={() => {
                                insert(form, "phones", { value: { phone: "", phoneType: "personal" } })
                            }} />
                        </section>
                    ...
                    <FormFields.Button
                        type="submit"
                        label={addRecruiterMutation.isPending ? "Adding..." : "Add Recruiter"}
                        variant="primary"
                    />
                </Form>
            </div>
