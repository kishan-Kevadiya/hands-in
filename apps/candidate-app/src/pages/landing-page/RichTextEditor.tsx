...
const RichTextEditor = () => {
  ...
  return (
    <div className="w-130 max-w-2xl mx-auto bg-[#fffdfd] rounded-2xl border-[2px] border-[#ffffff] overflow-hidden">
      {/* Header */}
      ...
      <div className="flex items-center justify-end space-x-3 px-6 py-4 rounded-b-xl border-t border-gray-100 mx-8 mb-8  bg-[#7517cc1f]">
        <button className="px-6 py-2 text-sm text-[#3D1562] bg-[#fafafa]  border-[2px] border-[#3d15623b] hover:bg-purple-800 transition-colors duration-150 rounded-lg hover:border-gray-300">
          Cancel
        </button>
