...
import Astronaught from "@/assets/svg/landingPage/Astronaught";
  ...
  return (
    ...
    <div className="relative flex h-screen w-screen items-center justify-center bg-gradient-to-br from-rose-50 to-purple-50 overflow-hidden">
      ...
      <div className="absolute flex items-center justify-center">
        ...
        <div className='absolute h-200 w-200 border border-[#DF6789] rounded-full'> <div className="absolute z-10 top-40 left-0"><Star width={70} /><Star width={30} /></div>   <div className="absolute z-10 top-1/2 -right-30"><Star width={60} /></div></div>
