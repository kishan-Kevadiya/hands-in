...
const SavedJobs: React.FC = () => {
    ...
    const refetchData = () => {
        queryClient.invalidateQueries({
            queryKey: [USE_QUERY_KEYS.GET_JOBS, 'SAVED'],
        });
    };
    ...
    return (
        <InfiniteScroll<JobData, { page: number; pageSize: number }>
            ...
            emptyComponent={
                <div className="w-full h-4/5 flex items-center justify-center text-primary text-lg font-semibold text-center">No Saved Applications Found.</div>
            }
            gridCols={2}
            direction="down"
