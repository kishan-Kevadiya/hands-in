            ...
            <form className="w-full h-full flex flex-col gap-4 bg-white rounded-2xl p-4 overflow-auto ">
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex flex-col">
                        ...
                        <p className="text-[#646464] md:text-sm text-xs">
                            Describe any problems or difficulties you
                            encountered while using HeadsIn.
                        </p>
                    </div>
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex flex-col">
                        ...
                        <p className="text-[#646464] md:text-sm text-xs">
                            Your input is valuable in helping us better
                            understand your needs and tailor our service
                            accordingly.
                        </p>
                    </div>
                    ...
                    <div className="flex md:gap-6 gap-3 md:pt-10 pt-6 md:h-26 h-20 items-center">
                        {RATING_EMOJI.map((emoji, index) => (
                            <button
                                onClick={() =>
                                    supportForm.setValue("rating", emoji.value)
                                }
                                type="button"
                                key={index}
                                className={`outline-none bg-[#ECECEC] rounded-full md:p-3 p-2 transition-all duration-100 ease-in cursor-pointer ${
                                    activeEmoji === emoji.value
                                        ? "bg-gradient-to-br from-[#DF6789] from-50% to-[#3F1562] scale-150 md:px-3 mx-2"
                                        : ""
                                }`}
                            >
                                {<emoji.label />}
                    ...
                    <div className="flex items-center gap-2 md:text-sm text-xs font-medium text-primary my-8">
                        ...
                        />
                        I consent to receive occasional emails from HeadsIn that
                        I can opt out of anytime / privacy policy
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center lg:pb-14 pb-8">
                    <AuthButton
                        ...
                        label="🚀 Send Your Thoughts"
                    />
                </div>
            </form>

            <div
                className="flex flex-col justify-between bg-[#FDF3F6] rounded-2xl px-8 py-10 lg:w-8/12 lg:h-[500px] bg-[length:15%] bg-right-bottom bg-no-repeat lg:gap-0 gap-6"
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-[#3E3E3E] font-medium lg:leading-loose md:text-base text-xs">
                            Let’s connect! Whether you need assistance or just
                ...
                <div className="flex flex-col md:gap-6 gap-4">
                    ...
                    <div className="flex gap-4">
                        <Link
                            ...
                            target="_blank"
                            className="flex items-center justify-center w-9 h-9 border border-primary rounded-full p-2 hover:bg-field"
                        >
                            <img
                                src={XIcon}
                                alt="x"
