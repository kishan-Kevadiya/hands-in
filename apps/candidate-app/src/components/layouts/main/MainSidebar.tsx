import LogoutDailogIcon from "@/assets/svg/log-out.svg";
...
import { getUser, logoutUser, resetPassword } from "@/helpers/apis/auth";
...
const SIDEBAR_ITEMS = [
    ...
    { title: "Resume", icon: <ResumeIcon />, to: RESUME },
...
const MainSidebar: React.FC<{
    ...
    return (
        <div
            className={twMerge(
                "relative w-full h-full bg-primary text-white font-manrope font-medium transition-all duration-100 ease-in-out",
        ...
        >
            ...
            {UserData?.data ? (
                <div className="w-full h-[calc(100%-100px)] pb-6 flex flex-col justify-between">
                    ...
                    <div className="flex flex-col items-center gap-1 px-3">
                        ...
                        <button
                            type="button"
                            className={twMerge(
                                "text-black flex items-center w-11/12 justify-start gap-4 hover:bg-white/30 py-3 px-4 rounded-md transition duration-300 ease-in-out cursor-pointer",
                                isCollapsed ? "w-auto" : "w-11/12"
                            )}
                ...
                <div className="w-full h-[calc(100%-100px)] pb-6 flex flex-col justify-end px-6">
                    <button
                        type="button"
                        className="bg-white text-primary font-semibold flex items-center justify-center gap-4 py-3 px-4 rounded-md transition duration-300 ease-in-out cursor-pointer"
                        onClick={() => navigate(LOGIN)}
                    >
                        <i className="pi pi-user"></i> <span>Login</span>
                    </button>
                </div>
            )}
