import { getCityList, getQualificationList } from "@/helpers/apis/jobs";
import { getRoles } from "@/helpers/apis/profile";
...
const MainLayout: React.FC = () => {
    ...
    async function globalData() {
        try {
            const [cities, roles, qualifications] = await Promise.all([
